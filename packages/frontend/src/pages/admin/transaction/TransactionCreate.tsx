...
export const TransactionCreatePage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(err.response?.data?.error || '記録の作成に失敗しました');
        } finally {
            setIsSubmitting(false);
        }
    };
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="p-8 space-y-6 overflow-y-auto flex-1 custom-scrollbar">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <AdminBreadcrumb items={BREADCRUMB_ITEMS['/admin/transaction/create'] || []} />
                            <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">新規記録登録</h2>
                        </div>
                    </div>
